...
if __name__ == '__main__':
    ...
    tweets = api.user_timeline(screen_name="Salud_Ec", count=200)
    ...
    time_tweets = pd.Series(data=df['sentiment'].values, index=df['date'])
    time_tweets.plot(figsize=(16, 4), label="sentiment", legend=True)
    plt.show()